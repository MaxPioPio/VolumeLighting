...
QOpenGLShaderProgram* GLUtils::createShaderProg(QString _vertPath, QString _fragPath, QString _tessCtrlPath, QString _tessEvalPath) {
       ...
       QString vertPath = SHADER_PATH + _vertPath;
       QString fragPath = SHADER_PATH + _fragPath;
       QString tessCtrlPath = SHADER_PATH + _tessCtrlPath;
       QString tessEvalPath = SHADER_PATH + _tessEvalPath;
